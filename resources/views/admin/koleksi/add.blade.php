				...
				<div class="card-body">
					<form action="/admin/galeri/{{$data_galeri->id}}/koleksi" method="post" enctype="multipart/form-data">
						...
						<div class="row mb-3">
							...
							<div class="form-group">
								<textarea id="desc" name="desc" class="form-control @error('desc') is-invalid @enderror" placeholder="Masukkan deskripsi koleksi/karya" aria-describedby="basic-icon-default-message2"></textarea>
								@error('desc')
									<div class="invalid-feedback">{{ $message }}</div>
								@enderror
							</div>
