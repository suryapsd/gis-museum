        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Bisokop</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tambah Data Bioskop</h6>
                        </div>
                        <div class="card-body">
                            <form action="/admin/museum" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-3">
                                   <label class="form-label" for="basic-default-name">Foto Bioskop</label>
                                   <div class="input-group">
                               ...
                               <div class="row mb-3">
                                   <div class="col-md-6">
                                       <label class="form-label" for="basic-default-name">Nama Bioskop</label>
